...
# Colors for shields.io (NO LOGOS, flat pill style for uniformity as in image)
LANGUAGE_MAP = {
    "Python": "3776AB",
    "Django": "092E20",
    "TypeScript": "3178C6",
...
for lang in final_langs:
    if lang in LANGUAGE_MAP:
        ...
        # style=flat creates the clean pill look without logos
...
print("Successfully updated readme.md with exact image design!")
